...
public class Agent_Process {
		...
		public void buysell() throws ClassNotFoundException, SQLException 
		{
			...
			else
			{
				...
				{
					stmt.executeUpdate("insert into agent_table(p_name,qty,tot_cost,price)values('"+p_name+"','"+qty+"','"+tot+"','"+p_price+"')");
					qty1=qty1-qty;
					String s1="update admin_table set p_minsellqty=qty1 where p_id='"+p_id1+"';";
		...
		private void showhistory() throws SQLException, ClassNotFoundException 
		{
			// TODO Auto-generated method stub
			Scanner sc=new Scanner(System.in);
			...
			System.out.println("product_id  product_name  product_quantity  product_price Total_cost");
			while(rs.next())
			{
